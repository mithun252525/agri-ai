    ...
    if(predictionData.final_prediction) {
        ...
        <div className="form">
            <div className="form__form_group">
                ...
                <center><div className="form__title">Effective Crop Selection</div></center>
                ...
                <Button onClick={()=>handleClick()} className="form__button" color="primary" variant="contained">Predict</Button>
            </div>
        </div>
    )
}
